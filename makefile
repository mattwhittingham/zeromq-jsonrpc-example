INCLUDES=-I/usr/local/include/cppconn/ -I/usr/local/include
...
app: app.cpp zmq-server-connector.o
	g++ -Wall $(INCLUDES) -lmysqlcppconn -lzmq -ljsoncpp -ljsonrpccpp-common -ljsonrpccpp-server app.cpp -o app zmq-server-connector.o
